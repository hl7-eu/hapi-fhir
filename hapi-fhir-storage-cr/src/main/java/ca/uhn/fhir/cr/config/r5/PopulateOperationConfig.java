...
public class PopulateOperationConfig {
	@Bean
	ca.uhn.fhir.cr.r5.questionnaire.QuestionnairePopulateProvider r5QuestionnairePopulateProvider() {
		return new ca.uhn.fhir.cr.r5.questionnaire.QuestionnairePopulateProvider();
	}
	...
	public ProviderLoader populateOperationLoader(
		...
		var selector = new ProviderSelector(
				...
				Map.of(
						FhirVersionEnum.R5,
						Arrays.asList(ca.uhn.fhir.cr.r5.questionnaire.QuestionnairePopulateProvider.class)));
