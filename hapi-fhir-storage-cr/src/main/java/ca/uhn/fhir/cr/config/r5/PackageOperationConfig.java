...
public class PackageOperationConfig {
	...
	@Bean
	ca.uhn.fhir.cr.r5.questionnaire.QuestionnairePackageProvider r5QuestionnairePackageProvider() {
		return new ca.uhn.fhir.cr.r5.questionnaire.QuestionnairePackageProvider();
	}
	...
	public ProviderLoader packageOperationLoader(
		...
		var selector = new ProviderSelector(
				...
				Map.of(
						FhirVersionEnum.R5,
						Arrays.asList(ca.uhn.fhir.cr.r5.questionnaire.QuestionnairePackageProvider.class)));
